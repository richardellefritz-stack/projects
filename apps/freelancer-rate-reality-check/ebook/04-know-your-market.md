...
You now have a number built from your costs. That number answers *what you need*. It doesn't yet answer *what your market will bear* — and those are different questions.
...
Vertical specialty in regulated industries — healthcare, finance, legal, insurance — and technical specialty in scarce or high-consequence areas are the two most consistent premium drivers across every category above.

## Lever Two: The AI Bifurcation

This is the part most published pricing advice hasn't caught up with, and it's the most consequential thing in this chapter.

The freelance market is currently splitting in two, and the split runs along a single line: **whether AI tooling makes your work cheaper to replace, or makes you more valuable to hire.**

On one side, rates in AI-exposed commodity categories are falling. Aggregated 2020–2026 comparisons report declines along these lines:

- Transcription: roughly −35%
- Data entry: roughly −28%
- Basic content writing: roughly −18%
- Basic graphic design: roughly −12%
- Common-language-pair translation: roughly −10%

On the other side, rates in AI-adjacent specialist categories are climbing:

- AI/ML specialists: roughly +45%
...
*Next: why the number you set first becomes the ceiling you fight — and how to break it.*
